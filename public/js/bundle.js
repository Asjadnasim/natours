      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Successfully created your account!');
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error in logged out! Please try again.');
        case 10:
        case "end":
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51NsSatSJ2ZvW1d90gbsRgVvm8WWyqKlrxtBQhD5roO4oQ7hkpZGds7JaXutuhjKAxbnkrlDezy1jaKdsyqs11NMR00yvukIKSQ');
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
exports.createReviewForTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(review, rating, tourId, userId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Successfully created your review!');
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
...
var createReviewForm = document.querySelector('.form--createReview');
var createReviewButton = document.querySelector('.create--review');
var sectionCreateReview = document.querySelector('.section-createReviews');
var submitButtonOnCreateReview = document.querySelector('.review-save');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          form.append('photo', document.getElementById('photo').files[0]);
          _context.next = 10;
          return (0, _login.signUp)(form, 'data');
        case 10:
        case "end":
          return _context.stop();
      }
...
if (createReviewForm) createReviewForm.addEventListener('submit', function (e) {
  ...
  var _submitButton$dataset = submitButton.dataset,
    tourId = _submitButton$dataset.tourId,
    userId = _submitButton$dataset.userId;
  // console.log('Hey I am e.target:', e.target);
  // console.log('Hey i am tour Id:', tourId);
  // console.log('Hey i am user Id:', userId);
  (0, _review.createReviewForTour)(review, rating, tourId, userId);
});
